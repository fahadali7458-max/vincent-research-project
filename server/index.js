...
// -------------------------------------------------------------
// 6. SERVE PRODUCTION STATIC ASSETS (EXPRESS V5 COMPATIBLE)
// -------------------------------------------------------------
const distPath = path.join(__dirname, '..', 'dist');
if (fs.existsSync(distPath)) {
  app.use(express.static(distPath));
  
  // Safe Express 5 Middleware Fallback (No wildcard string errors)
...
app.listen(PORT, () => {
  console.log(`VINCENT RESEARCH API Active on port ${PORT}`);
});
